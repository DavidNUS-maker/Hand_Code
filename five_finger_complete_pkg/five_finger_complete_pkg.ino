...
String readString;
int pos_1;
const PROGMEM int pos_1_roof = 50;
const PROGMEM int pos_1_floor = 140;
int pos_2;
const PROGMEM int pos_2_roof = 85;
const PROGMEM int pos_2_floor = 155;
int pos_3;
const PROGMEM int pos_3_roof = 130;
const PROGMEM int pos_3_floor = 30;
int pos_4;
const PROGMEM int pos_4_roof = 30;
const PROGMEM int pos_4_floor = 140;
int pos_5;
const PROGMEM int pos_5_roof = 130;
const PROGMEM int pos_5_floor = 35;
int pos_6;
const PROGMEM int pos_6_roof = 135;
const PROGMEM int pos_6_floor = 30;
...
//  if (current - start > 2000000 and TO_GRASP){
//    pinch_2();
//    TO_GRASP = !TO_GRASP;
//    }
}
